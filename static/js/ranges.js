const ranges = {
    ...
    showAddModal() {
        const body = `
            ...
            <div class="form-group"><label>Test Numbers (One per line)</label><textarea id="rng-test-numbers" class="fly-input" rows="3" placeholder="+1234567890"></textarea></div>`;
    ...
    async save() {
        const payload = {
            ...
            testNumbers: document.getElementById('rng-test-numbers').value
        };
        try {
